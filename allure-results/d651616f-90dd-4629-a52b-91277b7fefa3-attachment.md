...
- Name: CMS Application Automation >> Create Group >> Create Player
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:98:9
...
Call log:
  - waiting for getByRole('link', { name: 'Lan Manager' })
    ...
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:99:61
```

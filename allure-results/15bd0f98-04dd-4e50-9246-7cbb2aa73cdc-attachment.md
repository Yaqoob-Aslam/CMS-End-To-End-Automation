...
- Name: CMS Application Automation >> Group & Player Management >> Create Group
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:66:9
...
Call log:
  - waiting for getByRole('button', { name: 'Done' })
    ...
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:73:56
```
...
- dialog "Add New Group":
  ...
  - text: Group Name *
  - textbox "Enter group name": Group U16758
  - button "Cancel"
  - button "Add"
- dialog:
  - img "Tick"
  - heading "Error!" [level=3]
  - paragraph: Name has already been taken
  - button "Okay"
```

...
- Name: CMS Application Automation >> User Management & Logout >> Create Manager
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:188:9
...
Call log:
  - waiting for getByRole('link', { name: 'User Account' })
    ...
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:189:62
```

...
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:136:7
...
Call log:
  - waiting for getByRole('textbox', { name: 'Enter your email address' })
    - locator resolved to <input value="" name="email" type="email" min="2025-08-12" placeholder="Enter your email address" class="undefined text-primary-color-900 placeholder:text-primary-color-300 pl-4 h-11 w-full border rounded-lg border-primary-color-100 focus:border-primary focus:ring-primary  appearance-none py-2.5 pr-2.5 text-sm file:relative file:-top-0.5 file:rounded-lg focus:outline-none"/>
    - fill("admin@cms.com")
  - attempting fill action
    - waiting for element to be visible, enabled and editable

    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:56:75
```

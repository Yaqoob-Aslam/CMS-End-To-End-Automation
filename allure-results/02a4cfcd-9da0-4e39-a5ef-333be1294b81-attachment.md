...
- Name: CMS Application Automation >> Create Group >> Create Sub Subgroup
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:86:9
...
Call log:
  - waiting for getByRole('link', { name: 'Sub Subgroups' })
    ...
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:87:63
```
...
>  87 |       await page.getByRole('link', { name: 'Sub Subgroups' }).click();
  ...
  113 |   });
  114 |
  115 |   test.describe.skip('Content Management', () => {
  ...
  141 |   });
  142 |
  143 |   test.describe.skip('Scheduling', () => {
  ...
  185 |   });
  186 |
  187 |   test.describe.skip('User Management & Logout', () => {
```
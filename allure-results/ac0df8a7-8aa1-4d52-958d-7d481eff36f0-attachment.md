...
- Name: CMS Application Automation >> Create Scenario
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:124:7
...
Call log:
  - waiting for getByRole('button', { name: 'All Scenarios' })
    ...
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:125:63
```

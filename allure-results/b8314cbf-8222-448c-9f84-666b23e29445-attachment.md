...
- Name: CMS Application End-to-End Tests >> Create a new scenario
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS_Automation_1.0.spec.js:454:7
...
Call log:
  - waiting for getByRole('button', { name: 'All Scenarios' })
    ...
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS_Automation_1.0.spec.js:455:63
```

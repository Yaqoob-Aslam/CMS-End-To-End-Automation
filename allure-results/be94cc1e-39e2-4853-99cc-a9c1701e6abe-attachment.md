...
- Name: Create Player
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS_Automation_1.0.spec.js:397:5
...
Call log:
  - waiting for getByRole('link', { name: 'Lan Manager' })
    ...
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS_Automation_1.0.spec.js:398:57
```

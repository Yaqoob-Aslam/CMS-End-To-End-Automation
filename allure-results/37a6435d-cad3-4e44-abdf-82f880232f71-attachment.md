...
```
Error: locator.waitFor: Error: strict mode violation: getByRole('option') resolved to 270 elements:
...
Call log:
  - waiting for getByRole('option') to be visible
    ...
    at TimetablePage.createTimetable (/home/yaqoob/CMS-End-to-End-Automation-with-Playwright/pages/TimetablePage.js:40:23)
...
- dialog "Add New Time Table":
  ...
  - textbox "Enter time table name": Timetable U75289
  - text: Scenario *
  - subscript
  - subscript
  - log: 270 results available.Use Up and Down to choose options, press Enter to select the currently focused option, press Escape to exit the menu, press Tab to select the option and exit the menu.

...
- Name: CMS Application Automation >> Group & Player Management
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:64:7
...
- You have two different versions of @playwright/test. This usually happens
  when one of the dependencies in your package.json depends on @playwright/test.
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:65:9
```
...
- text: Email Address *
- textbox "Enter your email address": admin@cms.com
- text: Password *
- textbox "Enter your password": Admin@1234
...
>  65 |     test('Create Group', async () => {
  ...
  127 |     });
  128 |
  129 |     test.skip('Create Scenario', async () => {
  ...
  156 |     });
  157 |
  158 |     test.skip('Create Schedule', async () => {

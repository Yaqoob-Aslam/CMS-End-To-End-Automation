...
- Name: CMS End-to-End Automation >> Create Sub-Subgroup
- Location: /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:69:7
...
Call log:
  - waiting for getByRole('link', { name: 'Sub Subgroups' })
    ...
    at /home/yaqoob/CMS-End-To-End-Automation/tests/CMS-Test-Cases.spec.js:70:61
```
...
```ts
   ...
   60 |     await page.getByRole('link', { name: 'Subgroups' }).click();
